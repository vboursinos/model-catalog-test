...
@Service
@Transactional
public class ModelService extends AbstractSearchService<Model, ModelDTO>
  ...
  public Mono<ModelDTO> save(ModelDTO modelDTO) {
    ...
    GenericCallable<ModelDTO, ModelDTO, Model> callable =
        context.getBean(GenericCallable.class, "create", modelDTO, modelRepository, modelMapper);
  ...
  public Mono<ModelDTO> update(ModelDTO modelDTO) {
    ...
    GenericCallable<ModelDTO, ModelDTO, Model> callable =
        context.getBean(GenericCallable.class, "update", modelDTO, modelRepository, modelMapper);
    return Mono.fromCallable(callable).subscribeOn(jdbcScheduler);
  }
  ...
  public Mono<ModelDTO> partialUpdate(ModelDTO modelDTO) {
    ...
    GenericCallable<ModelDTO, ModelDTO, Model> callable =
        context.getBean(
            GenericCallable.class, "partialUpdate", modelDTO, modelRepository, modelMapper);
    return Mono.fromCallable(callable).subscribeOn(jdbcScheduler);
  }
  ...
  public Mono<ModelDTO> findOne(UUID id) throws FindOneException {
    ...
    GenericCallable<ModelDTO, ModelDTO, Model> callable =
        context.getBean(GenericCallable.class, "findById", id, modelRepository, modelMapper);
    return Mono.fromCallable(callable).subscribeOn(jdbcScheduler);
  }
  ...
  public Mono<Void> delete(UUID id) {
    ...
    GenericCallable<Void, ModelDTO, Model> callable =
        context.getBean(GenericCallable.class, "delete", id, modelRepository, modelMapper);
    return Mono.fromCallable(callable).subscribeOn(jdbcScheduler);
  }
  ...
  public Mono<Boolean> existsById(UUID id) {
    ...
    GenericCallable<Boolean, ModelDTO, Model> callable =
        context.getBean(GenericCallable.class, "existsById", id, modelRepository, modelMapper);
    return Mono.fromCallable(callable).subscribeOn(jdbcScheduler);
  }
}

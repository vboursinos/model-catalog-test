...
@Service
@Transactional
public class ModelStructureTypeServiceImpl extends ReactiveAbstractCrudServiceImpl<ModelStructureTypeDTO,ModelStructureType,UUID> implements ModelStructureTypeService {

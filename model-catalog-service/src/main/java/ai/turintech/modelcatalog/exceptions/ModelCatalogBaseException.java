...
/**
 * Exception in order to represent a problem in the Model Catalog.
 * This exception is the base exception for all the exceptions in the Model Catalog.
 * It is used to represent a problem in the Model Catalog.
 **/

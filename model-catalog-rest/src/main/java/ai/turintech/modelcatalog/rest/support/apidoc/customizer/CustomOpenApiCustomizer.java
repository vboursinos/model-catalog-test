...
public class CustomOpenApiCustomizer implements OpenApiCustomizer, Ordered {
    ...
    //TODO- Include a configuration object to the constructor to be able to handle all configuration parameters
    ...
    public void customise(OpenAPI openAPI) {
        Contact contact = new Contact()
            .name("jose@turintech.ai")
            .url("www.turintech.ai")
            .email("jose@turintech.ai");
        ...
        openAPI.info(new Info()
            ...
            .license(new License().name("Copyright Turintech.ai ALL rights reserved.").url("wwww.turintech.ai"))
        );

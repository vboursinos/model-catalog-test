...
public class OpenApiConfiguration {
  ...
  public static final String API_FIRST_PACKAGE =
      ModelCatalogRestResourcesPackage.class.getPackageName();

  @Bean
  @ConditionalOnMissingBean(name = "apiFirstGroupedOpenAPI")
  public GroupedOpenApi apiFirstGroupedOpenAPI(CustomOpenApiCustomizer jhipsterOpenApiCustomizer) {

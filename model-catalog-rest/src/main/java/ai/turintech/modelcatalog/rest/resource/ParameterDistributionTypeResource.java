...
public class ParameterDistributionTypeResource {
   ...
   *     ParameterDistributionTypeTO, or with status {@code 400 (Bad Request)} if the
   *     parameterDistributionType has already an ID.
  ...
  public Mono<ResponseEntity<ParameterDistributionTypeTO>> createParameterDistributionType(
    ...
    if (parameterDistributionTypeTO.getId() != null) {
      throw new BadRequestAlertException(
          "A new parameterDistributionType cannot already have an ID", ENTITY_NAME, "idexists");
    }
            ...
            result -> {
              try {
                return ResponseEntity.created(
                        new URI("/api/parameter-distribution-types/" + result.getId()))
                    .headers(
   ...
   *     ParameterDistributionTypeTO, or with status {@code 400 (Bad Request)} if the
   *     ParameterDistributionTypeTO is not valid, or with status {@code 500 (Internal Server
   *     Error)} if the ParameterDistributionTypeTO couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  ...
  public Mono<ResponseEntity<ParameterDistributionTypeTO>> updateParameterDistributionType(
      ...
      throws URISyntaxException {
    log.debug(
        "REST request to update ParameterDistributionType : {}, {}",
        id,
        parameterDistributionTypeTO);
    if (parameterDistributionTypeTO.getId() == null) {
  ...
  /**
   * {@code PATCH /parameter-distribution-types/:id} : Partial updates given fields of an existing
   * parameterDistributionType, field will ignore if it is null
   *
   * @param id the id of the ParameterDistributionTypeTO to save.
   * @param parameterDistributionTypeTO the ParameterDistributionTypeTO to update.
   * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated
   *     ParameterDistributionTypeTO, or with status {@code 400 (Bad Request)} if the
   *     ParameterDistributionTypeTO is not valid, or with status {@code 404 (Not Found)} if the
   *     ParameterDistributionTypeTO is not found, or with status {@code 500 (Internal Server
   *     Error)} if the ParameterDistributionTypeTO couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PatchMapping(
      value = "/parameter-distribution-types/{id}",
  ...
  public Mono<ResponseEntity<ParameterDistributionTypeTO>> partialUpdateParameterDistributionType(
      ...
      throws URISyntaxException {
    log.debug(
        "REST request to partial update ParameterDistributionType partially : {}, {}",
        id,
        parameterDistributionTypeTO);
    if (parameterDistributionTypeTO.getId() == null) {
      throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
   ...
   *     parameterDistributionTypes in body.
   */
   ...
   */
  @GetMapping(
      value = "/parameter-distribution-types",
   ...
   *     ParameterDistributionTypeTO, or with status {@code 404 (Not Found)}.
   */
  @GetMapping("/parameter-distribution-types/{id}")
  public Mono<ResponseEntity<ParameterDistributionTypeTO>> getParameterDistributionType(

...
public class BooleanParameterResource {
            ...
            result -> {
              try {
                return ResponseEntity.created(
                        new URI("/api/boolean-parameters/" + result.getParameterTypeDefinitionId()))
                    .headers(
   ...
   *     booleanParameterDTO, or with status {@code 400 (Bad Request)} if the booleanParameterDTO is
   *     not valid, or with status {@code 500 (Internal Server Error)} if the booleanParameterDTO
   *     couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  ...
  /**
   * {@code PATCH /boolean-parameters/:id} : Partial updates given fields of an existing
   * booleanParameter, field will ignore if it is null
   *
   * @param id the id of the booleanParameterDTO to save.
   * @param booleanParameterTO the booleanParameterDTO to update.
   * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated
   *     booleanParameterDTO, or with status {@code 400 (Bad Request)} if the booleanParameterDTO is
   *     not valid, or with status {@code 404 (Not Found)} if the booleanParameterDTO is not found,
   *     or with status {@code 500 (Internal Server Error)} if the booleanParameterDTO couldn't be
   *     updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PatchMapping(
      value = "/boolean-parameters/{id}",
   ...
   *     booleanParameterDTO, or with status {@code 404 (Not Found)}.
   */

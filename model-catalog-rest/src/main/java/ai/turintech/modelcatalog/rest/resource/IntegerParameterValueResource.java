...
/**
 * REST controller for managing {@link ai.turintech.modelcatalog.entity.IntegerParameterValue}.
 */
@RestController
@RequestMapping("/api")
public class IntegerParameterValueResource {
    ...
    public IntegerParameterValueResource(IntegerParameterValueFacade integerParameterValueFacade, IntegerParameterValueMapper integerParameterValueMapper) {
    ...
    public Mono<ResponseEntity<IntegerParameterValueTO>> getIntegerParameterValue(@PathVariable Long id) {

...
public class ExceptionTranslator extends ResponseEntityExceptionHandler
  ...
  protected Mono<ResponseEntity<Object>> handleExceptionInternal(
    ...
    body =
        body == null ? wrapAndCustomizeProblem((Throwable) ex, (ServerWebExchange) request) : body;
  ...
  private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
    if (ex instanceof ErrorResponseException) {
      ...
      if (exp.getBody() instanceof ProblemDetailWithCause) {
        ProblemDetailWithCause cause = (ProblemDetailWithCause) exp.getBody();
        return cause;
      }
    }
  ...
  protected ProblemDetailWithCause customizeProblem(
    ...
    Boolean check1 = err instanceof WebExchangeBindException;
    Boolean check2 = problemProperties == null || !problemProperties.containsKey(FIELD_ERRORS_KEY);
    if (check1 && check2) {
  ...
  private HttpStatus toStatus(final Throwable throwable) {
    ...
    if (throwable instanceof ErrorResponse)
      return HttpStatus.valueOf(((ErrorResponse) throwable).getBody().getStatus());
  ...
  private String getCustomizedErrorDetails(Throwable err) {
    ...
    if (activeProfiles.contains(ApplicationProfiles.SPRING_PROFILE_PRODUCTION)) {
  ...
  private HttpHeaders buildHeaders(Throwable err) {
    Boolean check1 = err instanceof BadRequestAlertException;
    return check1
  ...
  public Optional<ProblemDetailWithCause> buildCause(
      final Throwable throwable, ServerWebExchange request) {

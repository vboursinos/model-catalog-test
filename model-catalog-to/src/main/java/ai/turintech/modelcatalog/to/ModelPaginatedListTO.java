...
public class ModelPaginatedListTO extends AbstractTO implements Serializable{
    ...
    public ModelPaginatedListTO(List<ModelTO> docs, long totalDocs, int limit, int totalPages, int page, int pagingCounter, Boolean hasPrevPage, Boolean hasNextPage, Integer prevPage, Integer nextPage) {
        this.docs = docs;
